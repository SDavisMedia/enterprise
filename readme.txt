...
1. Upload `enterprise` to the `/wp-content/themes/` directory
2. Activate the theme through the 'Themes' menu in WordPress
3. Use the Theme Customizer settings under "Appearance -> Customize" to adjust Enterprise's settings
...
1. Through FTP, navigate to `your_website/wp-content/themes/` and in that directory, create a new folder as the name of your child theme. Something like `enterprise-child` is perfectly fine.
...
. . . . . . . . . . copy what's below . . . . . . . . . . . . 
	...
	/*
		...
		Author: your_name
		Author URI: 
		Description: Child theme for Enterprise
		Template: enterprise
	*/

	@import url("../enterprise/style.css");
...
Enterprise WordPress Theme, Copyright (C) 2014 Sean Davis - SDavis Media LLC
Enterprise is distributed under the terms of the GNU GPL
